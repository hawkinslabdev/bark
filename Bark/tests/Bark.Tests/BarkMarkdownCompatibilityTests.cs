...
public sealed class BarkMarkdownCompatibilityTests
{
...
""";
    ...
    [Fact]
    public void Parse_HomeLayout_RendersHeroAndFeatures()
    {
        var md = """
            ---
            layout: home
            hero:
              ...
              tagline: No build step.
              actions:
                - theme: brand
                  text: Get Started
                  link: /getting-started
                - text: GitHub
                  link: https://github.com/example/bark
            features:
              - icon: "⚡"
                title: Hot reload
                details: Edit and see it live.
              - title: Search
                details: Built in.
                link: /search
            ---

            Extra body content below the front matter.
            """;
